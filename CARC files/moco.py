...
# utils
parser.add_argument('--resume', default='', type=str, metavar='PATH', help='/home1/rshashan/cache-2023-03-30-14-09-05-moco/model_last.pth')
...
def copypaste(cifar_img):
    ...
    imagenet_path = '/home1/rshashan/tiny-imagenet-200-20230328T011153Z-001/tiny-imagenet-200/images/'
    tiny_imagenet = random.choice(os.listdir("/home1/rshashan/tiny-imagenet-200-20230328T011153Z-001/tiny-imagenet-200/images/"))
...
for ep in range(num_epochs):
    ...
    for data, label in tqdm(cp_trainloader):
        model.zero_grad()
        optimizer.zero_grad()
        data = data.cuda()
        label = label.cuda()
